...
// Returns the private 'App\Repository\ResetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ResetRepository.php';

return $this->privates['App\\Repository\\ResetRepository'] = new \App\Repository\ResetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
