...
// Returns the private 'App\Repository\SectionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SectionRepository.php';

return $this->privates['App\\Repository\\SectionRepository'] = new \App\Repository\SectionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
